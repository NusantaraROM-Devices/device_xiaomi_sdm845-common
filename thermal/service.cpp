...
static int shutdown() {
    LOG(ERROR) << "SDM845 Thermal HAL Service is shutting down.";
    return 1;
}
...
int main(int /* argc */, char ** /* argv */) {
    ...
    LOG(INFO) << "SDM845 Thermal HAL Service 2.0 starting...";
    ...
    LOG(INFO) << "SDM845 Thermal HAL Service 2.0 started successfully.";
    joinRpcThreadpool();
